...
## Project Structure
    ...
    ├── somethingforrob_de_110189  # Django project configurations
...
1. Clone this repo and `cd somethingforrob_de_110189`
...
2. Clone this repo and `cd somethingforrob_de_110189`
